...
class User(UserMixin, db.Model):
    ...
    doctor = db.relationship('Doctor', back_populates='user', uselist=False, cascade="all, delete")
    patient = db.relationship('Patient', back_populates='user', uselist=False, cascade="all, delete")
    ...
    def __repr__(self):
        ...
        return f"<User {self.username} ({roles})>"
